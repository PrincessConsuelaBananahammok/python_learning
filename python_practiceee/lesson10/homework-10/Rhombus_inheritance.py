...
# успадковуються від Employee. Клас Manager повинен мати додатковий атрибут department, а клас Developer - атрибут
...
team_lead1 = TeamLead("Bob", 2000, "Engine", "python", 10)


print(TeamLead.__mro__)

print(team_lead1.name)
print(team_lead1.department)
print(team_lead1.programming_language)
print(team_lead1.team_size)
print(team_lead1.salary)
